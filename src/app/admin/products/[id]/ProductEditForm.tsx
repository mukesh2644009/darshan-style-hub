...
export default function ProductEditForm({ product }: Props) {
  ...
  const subcategories: Record<string, string[]> = {
    ...
    'Summer Co-ord Sets': ['Co-ord Set with Shorts', 'Printed Summer Co-ord Sets', 'Cotton Summer Co-ord Sets', 'Casual Summer Co-ord Sets'],
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          ...
          <div className="flex items-center gap-4">
            <input
              type="number"
              min="0"
              value={sizeQuantities['Free Size']?.quantity ?? 1}
              onChange={(e) => setSizeQuantities(prev => ({
                ...prev,
                'Free Size': { ...prev['Free Size'], id: prev['Free Size']?.id || '', quantity: parseInt(e.target.value) || 0 }
              }))}
